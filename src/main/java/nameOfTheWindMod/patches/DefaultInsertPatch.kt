package nameOfTheWindMod.patches
...
object DefaultInsertPatch {
    ...
    private val logger = LogManager.getLogger(
        DefaultInsertPatch::class.java.name
    ...
    fun thisIsOurActualPatchMethod( // 1. "Patch methods are passed all the arguments of the original method,
    ...
    private class Locator : SpireInsertLocator() {
        ...
        override fun Locate(ctMethodToPatch: CtBehavior): IntArray { // All the locator has and needs is an override of the Locate method
            ...
            val finalMatcher: Matcher = MethodCallMatcher(RelicLibrary::class.java, "getRelic")
