...
import static nameOfTheWindMod.NameOfTheWindMod.makeRelicOutlinePath;
import static nameOfTheWindMod.NameOfTheWindMod.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = NameOfTheWindMod.makeID("BottledPlaceholderRelic");
